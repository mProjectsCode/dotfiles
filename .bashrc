...
# --- i changed these aliases to eza
alias ll='eza -alF'
alias la='eza -A'
alias l='eza -F'
...
# eval "$(oh-my-posh init bash --config "https://raw.githubusercontent.com/JanDeDobbeleer/oh-my-posh/main/themes/rudolfs-light.omp.json")"

# custom scripts
source "$HOME/scripts/project.sh"
